...
//                                .requestMatchers("/api/admin/**").permitAll()
        ...
        http.authenticationProvider(authenticationProvider(userDetailService,passwordEncoder()));
    ...
    public CommandLineRunner initData(RoleRepository roleRepository, UserRepository userRepository , PasswordEncoder passwordEncoder){
        return args -> {
            ...
            if(!userRepository.existsByUserName("user1")){
                Users user1 = new Users("user1" ,"user@example.com",passwordEncoder.encode("password1"));
                userRepository.save(user1);
            }
            if(!userRepository.existsByUserName("seller1")){
                Users seller1 = new Users("seller1" ,"seller@example.com",passwordEncoder.encode("password2"));
